...
getBibleSword links to the official CrossWire SWORD engine. SWORD 1.9.0 is licensed
...
archives. The release build may dynamically link Linux system copies of zlib, bzip2,
xz, ICU and cURL; those libraries are not redistributed in the archive.
